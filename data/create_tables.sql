...
CREATE TABLE IF NOT EXISTS "answer" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "text" text NOT NULL,
  "question_id" integer NOT NULL -- on ne peut pas tout de suite indiquer que cette clé est une clé étrangère qui fait référence à la table question, ûisque la table question n'existe pas encire ! (on le fera plus tard)
);
